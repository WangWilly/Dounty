...
export class OnChainTransactionController {
  constructor(private readonly onChainTransactionService: OnChainTransactionService) {}

  //////////////////////////////////////////////////////////////////////////////

  @Post('v1')
  async createOnChainTransaction(@Body() req: OnChainTransactionV1CreateReq): Promise<void> {
