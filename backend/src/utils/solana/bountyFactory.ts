...
export const BOUNTY_FACTORY_PROGRAM_ID = new PublicKey(
  BountyFactoryIDL.address,
);
...
export function getBountyFactoryProgramByConn(connection: Connection) {
  return new Program(BountyFactoryIDL as BountyFactory, { connection });
}
